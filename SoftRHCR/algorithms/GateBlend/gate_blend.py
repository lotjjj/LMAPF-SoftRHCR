...
class GateBlendAgent(IPPOAgent):
    def __init__(self, config, obs_info, action_dim, n_agents, n_actions=None):
        ...
        self.gate_hidden_dim = getattr(config, "gate_hidden_dim", 64)
        ...
        self.conflict_sparse_gate_supervision = getattr(config, "conflict_sparse_gate_supervision", False)
